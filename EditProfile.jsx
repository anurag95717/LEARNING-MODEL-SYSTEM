...
function EditProfile() {
  ...
  return (
    <div className='main-h-screen flex items-center justify-center bg-gray-100 px-4 py-10'>
        <div className='bg-white rounded-2xl shadow-lg p-8 max-w-xl w-full relative'>

            <FaArrowLeftLong  className='absolute top-[8%] left-[5%] w-[22px] h-[22px] cursor-pointer' onClick={()=>navigate('/profile')}/>
            ...
            {userData?.photoUrl ? <img src={userData?.photoUrl} className='w-24 h-24 rounded-full object-cover border-4 border-[black]' alt="" />:<div className='w-24 h-24 rounded-full text-white flex items-center justify-center  text-[30px] object-cover border-2 bg-[black] border-white'>
                ...
                <div>
                 ...
                 <div>
                    ...
                    <input id='name' type="text" placeholder={userData.name} accept='image/*' className='w-full px-4 py-2 border rounded-md text-sm' onChange={(e)=>setName(e.target.value)} value={name}/>
                ...
                <div>
                    ...
                    <textarea 
                    name='description'  placeholder="Tell us about yourself" rows={3} className='w-full px-4 py-2 border border-gray-300 rounded-md resize-none focus:ring-[black]' onChange={(e)=>setDescription(e.target.value)} value={description} />
